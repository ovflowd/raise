...
class RequestTester
{
	...
	public function registerServices($token)
	{
		...
		$body = json_encode(array(
					"services" => array(array('name'=>'temperature','parameters'=>array('temp'=>'double') , 'return_type' => 'float'),array('name'=>'pressure','parameters'=>array('press'=>'vagabond') , 'return_type' => 'float')),
						"timestamp" => round(microtime(true) *1000),
						'tokenId' => $token
						));
