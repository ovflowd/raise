...
class RequestTester
{
	...
	public function registerServices($token)
	{
		...
		$body = json_encode(array(
					"services" => array(array('name'=>'temperature','parameters'=>array('temp'=>'float') , 'return_type' => 'float'),array('name'=>'pressure','parameters'=>array('press'=>'float') , 'return_type' => 'float')),
						"timestamp" => round(microtime(true) *1000),
						'tokenId' => $token
						));
