...
final class DBServiceController
{
    ...
    public function select_service_by_id($id, $connection)
    {
        ...
        $select_service_by_id
                = "SELECT PK_Id, FK_Device, TE_Friendly_Name, TE_Service_Id, TE_Service_Type, TE_Description FROM service
    ...
    public function select_service_state_variables($service_id, $connection)
    {
        ...
        $select_service_state_variables
                = "SELECT PK_Id, TE_Name, EN_Send_Events, EN_Multicast, EN_Data_Type
