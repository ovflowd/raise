<div class="grid-container">
    <div class="grid-x grid-padding-x">
        ...
        <div class="large-6 medium-6 small-12 cell">
            ...
            <br>
            <div class="callout primary">
                Here you can list all the <b>logs</b> that are registered at RAISe and some information about it.
                The logs are a specie of audits that are stored on raise data base when any insertion trigger happens on
                <b>raise</b>.
            </div>
            <div class="callout table">
