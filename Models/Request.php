...
class Request
{
    /**
        ...
        /**
         *@var string  Address IP server request
         */
        private $server_ip;

        /**
         *@var string  Address IP clinte request
         */
        private $remote_ip;

        /**
         *@var string       Path request
         */
        private $path;
        ...
        /**
         *@var bool   Request validation
         */
        private $isValid;

        /**
         *@var string       Body request
         */
        private $body;

        /**
         *@var string   Code request response
         */
        private $response;
     ...
     *
     *@return bool request object validation
     */
     ...
     *
     *@param bool $validade Validation status value
     */
