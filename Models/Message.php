...
{
    /**
   *@var string   HTTP code of response message
   */
  public $code_http;

  /**
   *@var string   Couchbase code of response message.
   */
  public $code_cb;
  ...
  {
      $messageOut = (object) ['code' => $this->get_code_http(), 'message' => $this->get_message()];
