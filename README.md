...
--------|---------|-------|-----------|
Latest  | [![Build status](https://ci.appveyor.com/api/projects/status/7kwiofnek2p0hnc5?svg=true)](https://ci.appveyor.com/project/uiot/raise)   | [![Build Status](https://travis-ci.org/sant0ro/RAISe.svg?branch=sbr)](https://travis-ci.org/sant0ro/RAISe) | [Artifacts](https://ci.appveyor.com/project/uiot/raise/branch/sbr/artifacts) |
