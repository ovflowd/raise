...
include ROOT_REST_DIR . "/resources/slave_controller/control/slaveController.control.php";
include ROOT_REST_DIR . "/resources/device/control/deviceController.control.php";
include ROOT_REST_DIR . "/resources/service/control/serviceController.control.php";
include ROOT_REST_DIR . "/resources/action/control/actionController.control.php";
include ROOT_REST_DIR . "/resources/state_variable/control/stateVariableController.control.php";
