...
include $_SERVER['DOCUMENT_ROOT']."/properties/pages.properties.php";
include $_SERVER['DOCUMENT_ROOT']."/database/databaseController.db.php";
include $_SERVER['DOCUMENT_ROOT']."/control/resourcesController.control.php";
