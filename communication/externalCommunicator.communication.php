...
include $_SERVER['DOCUMENT_ROOT']."/util/socket.helper.php";
include $_SERVER['DOCUMENT_ROOT']."/util/restRouter.helper.php";
include $_SERVER['DOCUMENT_ROOT']."/properties/socket.properties.php";
