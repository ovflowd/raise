...
include $_SERVER['DOCUMENT_ROOT']."/uiot-api-rest/control/request.control.php";
include $_SERVER['DOCUMENT_ROOT']."/uiot-api-rest/communication/externalCommunicator.communication.php";
